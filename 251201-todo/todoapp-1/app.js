...
const addTodo = (input) => {
    ...
    deleteBtn.textContent = "x"; // kan bytas ut mot 'ta bort', 'delete todo' eller vad som helst annars
    ...
    // stryk över listan vid klick (eller change)
    checkbox.addEventListener("change", () => {
        // kolla om checkboxen är checked (console.log resultat för debug)
        console.log(checkbox.checked);
        if (checkbox.checked) {
            // lägger till dekoration på spannet om true
            span.style.textDecoration = "line-through";
        } else {
            // sätter 'none'-dekoration om false
